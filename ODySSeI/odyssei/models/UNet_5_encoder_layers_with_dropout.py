...
class UNet(nn.Module):
    ...
    """
    Models the 5 (encoder) layer U-Net with Dropout
    """
    ...
    def forward(self, x):
        ...
        e_x2 = self.Dropout(self.MaxPool(e_x1))
        e_x3 = self.CC_Block2_Encoder(e_x2)
        e_x4 = self.Dropout(self.MaxPool(e_x3))
        e_x5 = self.CC_Block3_Encoder(e_x4)
        e_x6 = self.Dropout(self.MaxPool(e_x5))
        e_x7 = self.CC_Block4_Encoder(e_x6)
        e_x8 = self.Dropout(self.MaxPool(e_x7))
