...
# Code modified from Gonfan, 2021, https://github.com/VainF/DeepLabV3Plus-Pytorch/tree/master

import models._resnet

from models._deeplab import (
    DeepLabHead,
    DeepLabHeadV3Plus,
    DeepLabV3,
...
def fetch_deeplabv3(output_stride=8, num_classes=2, atrous_conv=False):
    # Set up model
...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone):
    ...
    backbone = models._resnet.__dict__[backbone_name](
