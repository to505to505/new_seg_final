...
from training.callbacks import BestMetricWriter
...
class LightningCLI(cli.LightningCLI):
    ...
    def fit(self, model, **kwargs):
        ...
        # Set up run directory with checkpoints and best.txt
        run_dir = None
        if self.trainer.logger is not None:
            run_dir = self.trainer.logger.log_dir
        if run_dir is None:
        ...
        self.trainer.callbacks.append(
            BestMetricWriter(monitor=monitor, mode="max")
        )
