...
from training.lcr_metric import LargestComponentRatio
    ...
    def _on_eval_end_instance(self, log_prefix):
        if not self.trainer.sanity_checking:
            rank_zero_info(
                ...
                f"LCR: {self.trainer.callback_metrics[f'metrics/{log_prefix}_lcr_all'] * 100:.1f} | "
                f"Combined: {self.trainer.callback_metrics[f'metrics/{log_prefix}_combined'] * 100:.1f}{reset}"
            )
